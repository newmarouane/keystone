...
export const manifest = {
    ...
    models: [
        ...
        { id: 'grok-4.20-beta-0309-reasoning', imagePolicy: 'optional', type: 'text' },
        { id: 'gpt-5.2-chat-latest', imagePolicy: 'optional', type: 'text' },
        { id: 'grok-4.20-multi-agent-beta-0309', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'mimo-v2-pro', imagePolicy: 'forbidden', type: 'text' },
        { id: 'longcat-flash-chat-2602-exp', imagePolicy: 'forbidden', type: 'text' },
        { id: 'glm-4.7', imagePolicy: 'forbidden', type: 'text' },
        { id: 'gemini-3.1-flash-lite-preview', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'grok-4-1-fast-reasoning', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'minimax-m2.7', imagePolicy: 'forbidden', type: 'text' },
        { id: 'gpt-5.4-nano-high', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'qwen3.5-flash', imagePolicy: 'forbidden', type: 'text' },
        ...
        { id: 'mercury-2', imagePolicy: 'forbidden', type: 'text' },
        ...
        { id: 'glm-5v-turbo', imagePolicy: 'forbidden', type: 'text' },
        ...
        { id: 'mistral-small-2603', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'gemma-4-26b-a4b', imagePolicy: 'optional', type: 'text' },
        { id: 'gemma-4-31b', imagePolicy: 'optional', type: 'text' },
        ...
        { id: 'grok-4.20-multi-agent-beta-0309', imagePolicy: 'forbidden', type: 'text', search: true },
